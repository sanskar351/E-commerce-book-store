 ...
 <div class="container">
    <div class="content">
      ...
      <div class="right-side">
        ...
        <p>If you have any old books sell it here & purchase and explore latest books.You can ask any types of queries just send me message from here. It's my pleasure to help you.</p>
      <form action="#">
        <div class="input-box">
        ...
        <div class="input-box">
            ...
            <div class="btn btn-success">
                <a type="button"  href="" class="btn-success" >Send Now</a>
        </div>
            <div class="btn btn-success">
                <a type="button"  href="admin.jsp" class="btn-success" >Home</a>
        </div>
